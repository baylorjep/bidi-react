...
function VideographyRequest() {
  ...
  //       adjustedRange =
  //         currentMin <= 1500 ? "500-1500" : `${currentMin - 1000}-${currentMin}`;
  ...
  //       adjustedRange =
  //         currentMax >= 5500 ? "5500+" : `${currentMax}-${currentMax + 1000}`;
  //     }
            ...
            <div className="preference-description">
              <div className="preference-detail">
                {formData.eventDetails.priceQualityPreference === "1" && (
                  <p>
                    👉 Focus on finding budget-friendly options while maintaining
                    good quality
                  </p>
                )}
