...
function PlacedBidDisplay({ requestId }) { // Ensure requestId is properly destructured
    ...
    const truncateText = (text, maxLength, linelength) => {
        ...
        return spaceIndex === -1 ? text.substring(0, linelength) + "..." : text.substring(0, maxLength) + "...";
    };
...
<div className="job-info-grid">
    ...
    <div className="job-info-item">
        ...
        <span className="job-value">{truncateText(BidInfo.price_range, 20)}</span>
    </div>
    <div className="job-info-item">
        <span className="job-label">Location</span>
        <span className="job-value">{truncateText(BidInfo.location, 30, 6)}</span>
    </div>
    ...
    <div className="job-info-item">
        ...
        <span className="job-value">{truncateText(BidInfo.time_of_day, 15)}</span>
    </div>
</div>
            ...
            <div className="job-description">
                ...
                <p className="job-value">{truncateText(BidInfo.additional_comments, 50, 15)}</p>
            </div>
