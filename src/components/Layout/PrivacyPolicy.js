...
const PrivacyPolicy = () => {
    return (
        <>
            <Helmet>
                <title>Privacy Policy - Bidi</title>
                <meta name="description" content="Learn about how Bidi protects your personal information." />
                <meta name="keywords" content="privacy policy, Bidi, data protection" />
            </Helmet>
